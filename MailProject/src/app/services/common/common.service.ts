...
export class CommonService {
  ...
  constructor(private http: HttpClient) { }
   getMenuList() {
    ...
    const menu102:Menu = {'menuSeq':'1002','menuId':'M10002','menuName':'Tempalte Management','level':'1','url':''};
    ...
    const menu213:Menu = {'menuSeq':'1013','menuId':'M10013','parentMenu':'M10001','menuName':'Request Approval 4R1','level':'2','url':'request_approval'};
    const menu214:Menu = {'menuSeq':'1014','menuId':'M10014','parentMenu':'M10001','menuName':'Search','level':'2','url':'user_search'};
    //'parentMenu':'1001',
    const menu221:Menu = {'menuSeq':'1021','menuId':'M10021','parentMenu':'M10002','menuName':'Search Tempalte','level':'2','url':'tempalte_search'};
    const menu222:Menu = {'menuSeq':'1022','menuId':'M10022','parentMenu':'M10002','menuName':'Create Tempalte','level':'2','url':'template_crud'};
    //
